        ...
        child: Column(
          ...
          children: [
            ...
            _buildFeature(
              ...
              description: 'Altere informações, estoque, imagem, preço ou características de produtos já cadastrados.',
            ...
            _buildFeature(
              ...
              description: 'Atualize a quantidade disponível de cada produto e controle lotes e validade.',
              color: Colors.teal,
            ),
            const SizedBox(height: 18),
            _buildFeature(
              ...
              title: 'Ver Pedidos',
              description: 'Acompanhe todos os pedidos feitos pelos clientes, atualize status e veja detalhes de cada venda.',
              color: Colors.blue,
            ),
            const SizedBox(height: 18),
            _buildFeature(
              ...
              description: 'Atualize nome, descrição, foto, endereço e tipo de entrega da sua loja.',
              color: Colors.purple,
            ),
            const Spacer(),
            Row(

...
class UserProfileOnboardingScreen extends StatefulWidget {
  ...
  const UserProfileOnboardingScreen({Key? key, this.onContinue}) : super(key: key);

  @override
  State<UserProfileOnboardingScreen> createState() => _UserProfileOnboardingScreenState();
}

class _UserProfileOnboardingScreenState extends State<UserProfileOnboardingScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            _buildFeature(
              ...
              description: 'Mantenha seu endereço sempre atualizado para facilitar entregas e serviços.',
            ...
            _buildFeature(
              ...
              description: 'Após editar, lembre-se de salvar para manter seus dados atualizados.',
              color: Colors.blue,
            ),
            const Spacer(),
            Row(
              children: [
                ...
                const Expanded(
                  child: Text('Não mostrar novamente', style: TextStyle(fontSize: 14)),
                ),
              ],
            ),
            SizedBox(
